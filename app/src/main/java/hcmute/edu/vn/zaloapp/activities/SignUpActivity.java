...
import hcmute.edu.vn.zaloapp.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private  boolean isValidSignUpDetails(){ //check input
        if (encodedImage == null){
            ...
            return  false;
        }else  if(binding.inputPhoneNum.getText().toString().trim().isEmpty()){
            showToast("Enter phone number");
            return  false;
        }else  if(binding.inputPassword.getText().toString().trim().isEmpty()){
            showToast("Enter password");
            return  false;
        }else if(binding.inputConfirmPassword.toString().trim().isEmpty()){
            showToast("Confirm your password");
            return false;
        }else  if(!binding.inputPassword.getText().toString().trim().equals(binding.inputPassword
                .getText().toString().trim())){
            showToast("Pass word and confirm must be same");
            return false;
        }else {
            return true;
        }
